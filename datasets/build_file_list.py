...
if __name__ == '__main__':
    ...
    parser.add_argument('--rgb_prefix', type=str, default='img_', help="prefix of RGB frames")
    parser.add_argument('--flow_x_prefix', type=str, default='flow_x', help="prefix of x direction flow images")
    parser.add_argument('--flow_y_prefix', type=str, default='flow_y', help="prefix of y direction flow images", )
    parser.add_argument('--num_split', type=int, default=3, help="number of split building file list")
